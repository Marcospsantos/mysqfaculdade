...
select from loja.vinhos.vinho  a 
from loja.vinhos.vinho a 
join loja.vinhos.vinho b on a.id_vinicola = b.codigo_vinicola 
join loja.vinhos.vinicola c on a.id_reg = c.codigo_reg
order by b.ano_vinho;


select * from vinicola
inner join regiao
on vinicola.ID_REGIAO = ID_REGIAO;
